...
class ValidateMobileMoneyUseCase @Inject constructor(
    private val clientRepository: ClientRepository,
    private val preferenceRepository: PreferenceRepository,
    private val utilRepository: UtilRepository

): BaseFlowUseCase<ValidateMobileMoneyUseCase.Param, Resource<DepositEntity>>() {
        ...
        override fun run(param: Param?): Flow<Resource<DepositEntity>> = flow {
            ...
            try {
                ...
                param?.let {
                    ...
                    val response = clientRepository.validateTransferToMobileMoney(hashMap, "Bearer " + user.token)
