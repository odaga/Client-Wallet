...
class ConfirmTVUseCase @Inject constructor(
    private val clientRepository: ClientRepository,
    private val preferences: PreferenceRepository,
    private val utilRepository: UtilRepository
): BaseFlowUseCase<ConfirmTVUseCase.Param, Resource<ConfirmUtilityEntity>>() {
        ...
        try {
            ...
            param?.let {
                ...
                val map = HashMap<String, Any>().apply {
                    ...
                    this["customer_phone"]= "0${user.phone.takeLast(9)}"
...
//                    this["pin"] = user.pin
                ...
                val response = clientRepository.confirmTVPayment(type, map, "Bearer " + user.token)
