...
class ConfirmUmemeUseCase @Inject constructor(
    private val clientRepository: ClientRepository,
    private val preferences: PreferenceRepository,
    private val utilRepository: UtilRepository
): BaseFlowUseCase<ConfirmUmemeUseCase.Param, Resource<ConfirmUtilityEntity>>(){
    ...
    override fun run(param: Param?): Flow<Resource<ConfirmUtilityEntity>> = flow {
        ...
        try {
            ...
            param?.let {
                ...
                val response = clientRepository.confirmUmemePayment(map, "Bearer " + user.token)
