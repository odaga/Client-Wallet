package com.mcash.domain.usecases.umeme
...
class ValidateUmemeUseCase @Inject constructor(
    private val clientRepository: ClientRepository,
    private val preferences: PreferenceRepository,
    private val utilRepository: UtilRepository
): BaseFlowUseCase<ValidateUmemeUseCase.Param, Resource<ValidateUtilityEntity>>() {
    ...
    override fun run(param: Param?): Flow<Resource<ValidateUtilityEntity>> = flow {
        ...
        try {
            ...
            param?.let {
                ...
                val response = clientRepository.validateUmemeCustomer(map, "Bearer " + user.token)
