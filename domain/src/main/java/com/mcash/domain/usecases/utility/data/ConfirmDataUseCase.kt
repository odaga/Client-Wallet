...
class ConfirmDataUseCase @Inject constructor(
    private val clientRepository: ClientRepository,
    private val preferences: PreferenceRepository,
    private val utilRepository: UtilRepository
) : BaseFlowUseCase<ConfirmDataUseCase.Param, Resource<ConfirmUtilityEntity>>(){
    ...
    override fun run(param: Param?): Flow<Resource<ConfirmUtilityEntity>> = flow {
        ...
        try {
            ...
            param?.let {
                ...
                val response = clientRepository.confirmDataPayment(type, map, "Bearer " + user.token)
